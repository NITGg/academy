...
$string['allowedorigins'] = 'Allowed browser origins (CORS)';
$string['allowedorigins_desc'] = 'Optional comma-separated list of web origins (e.g. https://app.example.com) permitted to read this endpoint\'s response from a browser. Native mobile apps are unaffected. Leave empty to send no CORS header (most restrictive).';
