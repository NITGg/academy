...
$string['fieldgroup_help'] = 'اختياري. الحقول اللي ليها نفس المجموعة بتظهر مع بعض تحت عنوان واحد في الفورم. سيبه فاضي عشان الحقل مايتجمّعش.';
$string['fieldgroup_en'] = 'المجموعة (إنجليزي)';
$string['fieldgroup_ar'] = 'المجموعة (عربي)';
