...
$string['fieldautofill'] = 'التعبئة المسبقة من الحساب';
$string['fieldautofill_help'] = 'بيملّي الحقل ده للمتقدّم بقيمة من حسابه هو، عشان ما يكتبهاش تاني. وبيقدر يعدّل القيمة الظاهرة قبل ما يبعت. "تلقائي" بيملّي الحقول اللي اسمها بيدل على الاسم الكامل أو البريد الإلكتروني؛ اختار "من غير تعبئة" عشان تقفلها للحقل ده.';
$string['fieldautofill_auto'] = 'تلقائي (يتحدد من اسم الحقل)';
$string['fieldautofill_none'] = 'من غير تعبئة';
$string['fieldautofill_fullname'] = 'الاسم الكامل من الحساب';
$string['fieldautofill_email'] = 'البريد الإلكتروني من الحساب';
...
// رقم الهاتف: مفتاح الدولة + الرقم المحلي (AC-4.20.4).
$string['phonecountry'] = 'مفتاح الدولة';
$string['errphonecountry'] = 'من فضلك اختار مفتاح دولة رقم تليفونك.';
$string['errphonedigits'] = 'من فضلك اكتب رقم تليفونك بالأرقام.';
$string['errphonelength'] = 'رقم التليفون للدولة دي لازم يكون {$a} أرقام.';
$string['errphonelengthrange'] = 'رقم التليفون للدولة دي لازم يكون بين {$a->min} و {$a->max} رقم.';
