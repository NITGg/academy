...
$string['guest_userid'] = 'حساب تصفح الضيوف (معرّف المستخدم)';
$string['guest_userid_desc'] = 'معرّف (id) الحساب الذي يخصّه توكن تصفح الضيوف. الأسعار تعامل طلبات هذا الحساب كزائر (تحديد الدولة من عنوان الـIP، ثم الدولة التي يرسلها التطبيق، ثم السعر الافتراضي) بدلًا من عضو بلا دولة في ملفه — وإلا فكل طلب قبل تسجيل الدخول يرجع بسعر 0 و«حدّد دولتك». اتركه 0 إذا أُنشئ الحساب عبر <code>cli/app_guest_token.php</code> الذي يعلّمه بدور <code>nit_app_guest</code>.';
