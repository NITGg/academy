...
$string['filterfieldsdesc'] = 'يعرض الدليل عوامل التصفية الستة في SRS §4.8 بالضبط — التصنيف والمستوى والسعر واللغة والمدة والشهادة. التصنيف والسعر مدمجان، وكذلك الشهادة: الكورس «يمنح شهادة» عندما يحتوي على نشاط شهادة ظاهر، فلا يوجد حقل يُعلَّم. أما الثلاثة الباقية فتقرأ حقلًا مخصّصًا للكورس تُسمّيه بالأسفل. اترك الخانة فارغة لاستخدام الاسم المختصر الافتراضي، وإذا سمّيت حقلًا غير موجود فلن يظهر عامل التصفية هذا في اللوحة أصلًا.';
...
// قسم «لماذا يختار الآلاف» أسفل بانر كل صفحة تصنيف.
$string['whychoose'] = 'قسم «لماذا يختارنا»';
$string['whychoose_intro'] = 'يظهر هذا القسم أسفل البانر في كل صفحة تصنيف. عدّل نصوصه الثلاثة أدناه، وأضف البطاقات أو رتّبها أو احذفها. يمكن إدخال كل نص بالإنجليزية والعربية؛ وتعرض الصفحة لغة الزائر.';
$string['whychoose_texts'] = 'نصوص القسم';
$string['whychoose_header1'] = 'العنوان الأول';
$string['whychoose_header1_desc'] = 'السطر الأول باللون المميز — مثل «لماذا يختار الآلاف».';
$string['whychoose_header2'] = 'العنوان الثاني';
$string['whychoose_header2_desc'] = 'السطر الثاني الذي يحمل الخط السفلي — مثل «إيـــاك خبراء التدريب في الشرق الاوسط».';
$string['whychoose_description'] = 'الوصف';
$string['whychoose_description_desc'] = 'الفقرة أسفل العنوانين.';
$string['whychoose_lang_en'] = 'الإنجليزية';
$string['whychoose_lang_ar'] = 'العربية';
$string['whycards'] = 'البطاقات';
$string['whycard_add'] = 'إضافة بطاقة';
$string['whycard_edit'] = 'تعديل البطاقة';
$string['whycard_image'] = 'الصورة';
$string['whycard_image_help'] = 'اختيارية. البطاقة التي لها صورة تعرضها مكان رقم البطاقة، لذا يُفضَّل أن تكون أيقونة أو شعارًا مربعًا (JPG، PNG، GIF، SVG، WebP).';
$string['whycard_noimage'] = 'لا توجد (يُعرض الرقم)';
$string['whycard_title'] = 'العنوان';
$string['whycard_body'] = 'النص';
$string['whycard_titlerequired'] = 'أدخل عنوانًا للبطاقة بلغة واحدة على الأقل.';
$string['whycard_none'] = 'لا توجد بطاقات بعد — يعرض القسم نصوصه فقط.';
$string['whycard_deleted'] = 'تم حذف البطاقة.';
$string['whycard_confirmdelete'] = 'هل تريد حذف البطاقة «{$a}»؟ ستُحذف صورتها معها.';
