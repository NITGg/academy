...
$string['whychoose_intro'] = 'This section is shown under the banner of every category page. Edit its three texts below, and add, reorder or remove the cards. Every text can be given in English and in Arabic; the page shows the visitor\'s language.';
$string['whychoose_texts'] = 'Section texts';
$string['whychoose_header1'] = 'Heading 1';
$string['whychoose_header1_desc'] = 'The first line, in the accent colour — e.g. "Why thousands choose".';
$string['whychoose_header2'] = 'Heading 2';
$string['whychoose_header2_desc'] = 'The second line, with the underline — e.g. "EAAC — the training experts of the Middle East".';
$string['whychoose_description'] = 'Description';
$string['whychoose_description_desc'] = 'The paragraph under the headings.';
$string['whychoose_lang_en'] = 'English';
$string['whychoose_lang_ar'] = 'Arabic';
$string['whycards'] = 'Cards';
$string['whycard_add'] = 'Add card';
$string['whycard_edit'] = 'Edit card';
$string['whycard_image'] = 'Picture';
$string['whycard_image_help'] = 'Optional. A card with a picture shows it where the card number would be, so it is best as a square icon or logo (JPG, PNG, GIF, SVG, WebP).';
$string['whycard_noimage'] = 'none (number shown)';
$string['whycard_title'] = 'Heading';
$string['whycard_body'] = 'Text';
$string['whycard_titlerequired'] = 'Give the card a heading in at least one language.';
$string['whycard_none'] = 'No cards yet — the section shows its texts only.';
$string['whycard_deleted'] = 'Card deleted.';
$string['whycard_confirmdelete'] = 'Delete the card "{$a}"? Its picture is deleted with it.';
