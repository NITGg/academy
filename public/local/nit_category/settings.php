...
if ($hassiteconfig) {
    ...
    // The "Why thousands choose us" section under the hero of every category page is NOT
    // configured here: it is the "Why choose us" tab of the Site pages manager
    // (/local/profilefields/manage.php?tab=whychoose), next to the other page content the
    // admin writes. See \local_nit_category\whychoose_ui.
