    ...
    public static function execute_returns(): external_multiple_structure {
        return new external_multiple_structure(
            new external_single_structure([
                ...
                'description'    => new external_value(PARAM_RAW, 'Description in the requested language (may be empty)'),
                ...
                'usage_limit'    => new external_value(PARAM_INT, 'Global redemption cap, all students together (0 = unlimited)'),
                'user_limit'     => new external_value(PARAM_INT, 'Redemptions one student may make (0 = unlimited)'),
                'user_usage_count' => new external_value(PARAM_INT, 'How many times the calling user has redeemed it (0 for a guest)'),
                'user_uses_left' => new external_value(PARAM_INT,
                    'Redemptions the calling user has left under user_limit; null when uncapped or a guest'),
