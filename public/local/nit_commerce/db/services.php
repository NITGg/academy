...
$functions = [
    'local_nit_commerce_get_available_coupons' => [
        ...
        'methodname'  => 'execute',
        'description' => 'List the discount coupons the calling user can redeem now: active, in window, under the site-wide cap (usage_limit) and under their own per-student cap (user_limit); user_usage_count / user_uses_left belong to the calling user.',
        'type'        => 'read',
        'ajax'        => true,
