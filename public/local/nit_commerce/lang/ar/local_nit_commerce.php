...
$string['cpn_open_category'] = 'تصفّح التصنيف';
...
// سطر توضيحي تحت كل حقل في نموذج الكوبون.
$string['cpn_help_name']   = 'يظهر للطلاب على بطاقة الكوبون وفي صفحة الدفع، باللغة التي يتصفحون بها.';
...
$string['cpn_scope_categories_help'] = 'اختيار التصنيفات يربط هذا بفرع من الكتالوج: عندها لا يُطبَّق إلا داخل تلك التصنيفات (وتصنيفاتها الفرعية)، ولا يظهر إلا في صفحاتها. أما الكورسات والخطط بالأسفل فتختار من داخل ذلك الفرع — فـ«البرمجة» مع «كل الكورسات» تعني كل كورس تحت البرمجة. وإن لم تختر أي تصنيف فسيُحدَّد نطاقه بالكورسات والخطط وحدها، ويظهر حيث تقع تلك العناصر.';
...
// الكوبون مقابل العرض: العنصر الذي عليه عرض ساري لا يقبل أكواد الخصم — يُطبَّق العرض ويُوضع الكود
// جانبًا (AC-4.12.6). الصياغة عمدًا ليست مقارنة («العرض يوفّر لك أكثر»): قد يكون الكود أكبر من العرض فعلًا.
$string['co_coupon_notwithoffer'] = 'الكود صحيح، لكن هذا العنصر عليه عرض ساري بالفعل، ولا يمكن استخدام أكواد الخصم مع العروض. تم تطبيق العرض.';
