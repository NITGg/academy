...
$string['events_intro'] = 'كل حدث يستطيع الموقع إبلاغ المتعلّم به، وكيفية الإبلاغ. اختر <strong>بريد إلكتروني</strong> لإرسال رسالة عند وقوع الحدث، واختر <strong>إشعار</strong> لعرضه على جرس الإشعارات في الشريط العلوي (وهو نفسه ما يصل إلى تطبيق الجوال). إلغاء اختيار قناة يوقفها للجميع، ولا يستطيع المستلمون إعادة تشغيلها لأنفسهم. واختيارها يعيد تشغيلها افتراضيًا مع بقاء حق كل شخص في إيقافها من تفضيلات الإشعارات الخاصة به.';
...
$string['events_providerdisabled'] = 'موقوف';
...
$string['events_seealso'] = 'هذه هي الإعدادات نفسها الموجودة في صفحة <a href="{$a}">إعدادات الإشعارات</a> في الموقع، معروضة بحدث واحد في كل صف. استخدم تلك الصفحة للحالات الأدق: السماح بقناة دون تشغيلها افتراضيًا، أو فرضها بحيث لا يستطيع أحد إيقافها.';
