...
// الفيديو التعريفي للكورس — الحقل الذي يلي "صورة الكورس" في نموذج إعدادات الكورس.
$string['promovideo'] = 'الفيديو التعريفي للكورس';
$string['promovideo_help'] = 'مقطع قصير يعرّف بالكورس. في صفحة الكورس يحل محل صورة الكورس: يظهر زر تشغيل فوق الصورة، وعند الضغط عليه يعمل الفيديو مكانها بينما يختفي العنوان والتفاصيل بسلاسة.

ارفع ملف **MP4 (فيديو H.264 وصوت AAC)** أو WebM، أو اترك هذا الحقل فارغًا وضع رابطًا في الحقل التالي. إذا وُضع الاثنان معًا يُستخدم الملف المرفوع.';
$string['promovideo_url'] = 'رابط الفيديو التعريفي';
$string['promovideo_url_help'] = 'بدلًا من رفع ملف، ضع رابط صفحة فيديو على **YouTube** أو **Vimeo** (مثل https://www.youtube.com/watch?v=… أو https://vimeo.com/…)، أو رابطًا مباشرًا لملف .mp4 / .webm.';
$string['promovideo_url_invalid'] = 'هذا الرابط ليس فيديو على YouTube أو Vimeo، وليس رابطًا مباشرًا لملف .mp4 / .webm / .ogv.';
