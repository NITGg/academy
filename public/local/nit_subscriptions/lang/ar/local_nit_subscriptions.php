...
$string['rem_window_none'] = 'لا توجد مهلة قبل انتهاء الخطة، لذا لا يظهر زر التجديد — فقط الرسالة يوم الانتهاء.';
...
$string['reminder_msg_body_today']    = 'انتهى اشتراكك "{$a->plan}" في {$a->expires}، لذا لم تعد الدورات التي كان يغطيها متاحة لك. لم يضع شيء مما أنجزته — تقدّمك ودرجاتك وشهاداتك محفوظة، والتجديد يعيدك إلى ما توقفت عنده بالضبط.';
...
// يُكتب في سجلّ الاسترداد الذي ينشئه خيار «إلغاء الشراء واعتباره مستردًّا»، حتى يتمكّن التقرير
// المالي من بيان وجهة هذه الأموال دون الاعتماد على ذاكرة المسؤول.
$string['mc_refund_reason']   = 'إلغاء الشراء بواسطة مدير (إدارة الدورات)';
...
$string['sub_price_home_help']    = 'اللي بيدفعه المشترك في {$a}، بالعملة المحلية دايمًا.';
