...
class get_courses_with_pricing extends external_api {
    ...
    public static function execute(string $field = '', string $value = '', string $country = ''): array {
        ...
        // filtering, capability checks, and formatted output for free. In Moodle 4.2+
        // this lives in the namespaced core_course\external\get_courses_by_field class.
        $core_result = \core_course\external\get_courses_by_field::execute(
            $params['field'],
            $params['value']
        );
