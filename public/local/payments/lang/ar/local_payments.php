...
$string['refund_terms_saved'] = 'تم حفظ سياسة الاسترداد لهذا المقرر.';
...
// ── قاعدة السعرين، مُلزِمة (course_pricing.php + course_pricing_form) ────────
$string['pricing_first_heading'] = 'حدّد سعر الكورس';
$string['pricing_first_note'] = 'الكورس المدفوع يحتاج سعرين، والنموذج ده بيطلب الاتنين مرة واحدة. الصف الواحد لوحده معناه إن نصّ المشترين بيتسعّروا بعملة النصّ التاني، ومفيش لحظة يكون فيها الكورس نصّ مسعّر. تقدر تضيف دول تانية بعد كده.';
$string['pricing_first_homehdr'] = '١. {$a} — السعر المحلي';
$string['pricing_first_homehelp'] = 'اللي بيدفعه المشتري في {$a->country}، بعملة {$a->currency}. من غير الصف ده بيقع على السعر اللي تحت ويتسعّر بعملة أجنبية. العملة مثبّتة حسب دولة الموقع الافتراضية — مش اختيار هنا، لأن «السعر المحلي بالدولار» هو بالظبط الغلط اللي الفورم ده موجود عشان يمنعه.';
...
$string['pricesfirstsaved'] = 'اتحفظ السعرين. الكورس بقى معروضًا للبيع.';
...
$string['error_would_break_pricing'] = 'التغيير ده هيخلّي الكورس معروضًا للبيع بنصف أسعاره: لازم يكون فيه سعر محلي مفعّل وسعر افتراضي مفعّل بعملة مختلفة. صلّح الصف التاني الأول، أو استخدم «احذف كل الأسعار» عشان توقف بيع الكورس.';
$string['error_delete_would_break'] = 'مش ممكن حذف السعر ده: هيخلّي الكورس معروضًا للبيع بنصف أسعاره. عشان توقف بيع الكورس استخدم «احذف كل الأسعار» بدل كده.';
$string['pricing_removeall'] = 'احذف كل الأسعار (اجعل الكورس مجانيًا)';
$string['confirmdeleteallprices'] = 'حذف كل أسعار الكورس ده؟ هيبقى كورسًا مجانيًا يقدر أي حد يلتحق بيه، ومش هيتحصّل عليه أي مبلغ.';
$string['pricesallremoved'] = 'اتحذفت كل الأسعار. الكورس بقى مجانيًا.';
$string['pricing_incomplete_legacy'] = 'الكورس ده اتسعّر قبل ما تبقى قاعدة السعرين موجودة. مفيش حاجة دلوقتي تقدر تنشئ كورسًا نصّ مسعّر — نموذج السعر بيطلب الاتنين، ولا التعديل ولا الحذف مسموح لهم يكسروا كورسًا أسعاره سليمة — لكن الكورس القديم لازم يتكمّل بالإيد.';
