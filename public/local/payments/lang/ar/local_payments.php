...
$string['refund_feepercent'] = 'رسوم الاسترداد الافتراضية (%)';
$string['refund_feepercent_desc'] = 'نسبة مئوية من المبلغ المدفوع تُحتجز عند تنفيذ الاسترداد. تُستخدم عندما لا تحدد قاعدة السعر رسوماً خاصة بها. وهي نسبة مئوية لا مبلغاً ثابتاً عن قصد: فالنسبة تمثل السياسة نفسها بكل العملات، أما المبلغ الثابت فيعني رسمين مختلفين لمن يدفع بالجنيه ولمن يدفع بالدولار. حدد المبلغ الثابت في قاعدة السعر حيث تكون العملة معروفة. القيمة 0 تعني استرداداً كاملاً.';
...
$string['refund_terms_intro'] = 'اترك الحقلين فارغين لاستخدام سياسة الموقع، وهي حالياً نافذة {$a->hours} ساعة برسوم {$a->fee}%.';
$string['refund_terms_inherit'] = 'سياسة الموقع';
$string['refund_terms_offsitewide'] = 'خدمة الاسترداد متوقفة على مستوى الموقع، لذا لن يسري أي إعداد هنا حتى يتم تفعيلها.';
$string['refund_terms_help'] = 'الرسوم نسبة مئوية مما دفعه المشتري فعلياً، فيكفي رقم واحد لكل العملات التي يُسعَّر بها المقرر ويتبع أي خصم استخدمه. اضبط النافذة على 0 لمنع الاسترداد التلقائي — فيضطر المشتري عندها إلى تقديم طلب يبتّ فيه أحد الموظفين.';
...
// ── قسم «تسعير الدورة» في course/edit.php (local\hooks\course_form + course_pricing) ──
$string['pricing_first_homehdr'] = '١. {$a} — السعر المحلي';
$string['pricing_first_homehelp'] = 'اللي بيدفعه المشتري في {$a}، بالعملة اللي تختارها هنا. من غير الصف ده بيقع على السعر الافتراضي اللي تحت ويتسعّر بعملة أجنبية.';
$string['pricing_first_defaulthdr'] = '٢. باقي العالم — السعر الافتراضي';
$string['pricing_first_defaulthelp'] = 'اللي بيدفعه أي مشترٍ خارج {$a}، بعملة دولية. الصف ده كمان هو المستخدَم لأي زائر تعذّر تحديد دولته، فمستحيل يكون الكورس من غيره.';
$string['error_same_currency'] = 'السعر الافتراضي لازم يكون بعملة مختلفة عن العملة المحلية — وإلا يبقى هو السعر المحلي مرتين، والمشترون في الخارج بيتسعّروا بعملة محلية.';
$string['pricing_section_note'] = 'الأسعار بتتحدّد حسب الدولة. المشتري المسجّل دخوله بيتسعّر حسب الدولة اللي في بروفايله — ولو ما فيش دولة ما بيظهرش له أي سعر ولا يقدر يشتري لحد ما يحدّدها. الزائر بتتحدّد دولته من عنوان الـ IP. أي حد دولته ما لهاش سعر خاص، وأي زائر تعذّر تحديد دولته، بيشوف السعر الافتراضي. سيب كل الأسعار فاضية لو عايز الكورس مجانيًا. {$a}';
$string['pricing_incomplete_form'] = 'كمّل الناقص تحت. الفورم ده بيحفظ الكورس بس لو فيه السعر المحلي والسعر الافتراضي مع بعض (بعملتين مختلفتين)، أو لو كل الأسعار فاضية (كورس مجاني).';
$string['pricing_other_intro'] = 'دول تانية: سعر لدولة معيّنة بالعملة اللي تختارها. المشتري من دولة ما لهاش صف هنا بيشوف السعر الافتراضي.';
$string['pricing_other_row'] = 'سعر الدولة {no}';
$string['pricing_other_none'] = '(لا شيء — الصف ده بيتحذف عند الحفظ)';
$string['pricing_other_add'] = 'أضِف سعرًا لدولة تانية';
$string['error_currency_unknown'] = 'عملة غير معروفة.';
$string['error_other_country_required'] = 'اختار الدولة اللي السعر ده ليها، أو امسح السعر.';
$string['error_other_country_reserved'] = 'الدولة دي ليها صف خاص فوق.';
$string['error_home_required'] = 'الكورس المدفوع محتاج سعر {$a} كمان. اكتبه، أو امسح كل الأسعار عشان يبقى الكورس مجانيًا.';
$string['error_default_required'] = 'الكورس المدفوع محتاج السعر الافتراضي كمان. اكتبه، أو امسح كل الأسعار عشان يبقى الكورس مجانيًا.';
$string['error_refund_hours'] = 'نافذة الاسترداد لازم تكون عدد صحيح من الساعات، 0 أو أكتر. سيبها فاضية عشان تتبع سياسة الموقع.';
$string['error_refund_fee'] = 'رسوم الاسترداد لازم تكون نسبة مئوية بين 0 و100. سيبها فاضية عشان تتبع سياسة الموقع.';

// ── الدرجة الثانية في سُلّم تحديد الدولة (country_diagnose.php) ──────────────
$string['geodiag_online'] = 'البحث المجاني عبر الإنترنت‏ (profilefield_phone)';
$string['geodiag_onlineonly'] = 'يعمل، لكن على الدرجة البطيئة. لا توجد قاعدة GeoIP2 محلية مضبوطة، فأي عنوان غير مخزَّن في الكاش بيكلّف طلبًا خارجيًا عبر HTTPS (حتى ثانية واحدة، مرة لكل عنوان في اليوم). ده نفس البحث اللي بيستخدمه فحص الدولة في صفحة التسجيل، يعني مش معطّل — لكن ملف mmdb. محلي هيخلّيه قراءة من القرص بدل طلب شبكة. من: إدارة الموقع ← الموقع الجغرافي ← البحث عن عنوان IP.';
