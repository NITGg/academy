...
$string['price_refund_fee'] = 'رسوم الاسترداد';
$string['price_refund_fee_help'] = 'المبلغ الذي يُخصم إذا تم استرداد هذا الشراء، بعملة هذه القاعدة نفسها. فالقاعدة المسعّرة بالجنيه تأخذ رسوماً بالجنيه، والمسعّرة بالدولار تأخذ رسوماً بالدولار. ولهذا توضع الرسوم هنا لا في خانة واحدة على مستوى الموقع: فالمقرر نفسه المُباع بـ 36 جنيهاً وبـ 450 دولاراً لا يمكن أن يشترك في رقم ثابت واحد.

اتركها فارغة لاستخدام سياسة الاسترداد الخاصة بالمقرر أو بالموقع، وهي عادةً نسبة مئوية. وأدخل 0 لاسترداد هذا السعر كاملاً، وهو أمر مختلف عن تركها فارغة.

أما نافذة الاسترداد — أي المدة المتاحة للمشتري — فلا تُضبط هنا، لأنها واحدة مهما كانت طريقة الدفع، ومكانها سياسة الاسترداد الخاصة بالمقرر.';

// Refund terms set on a price rule.
$string['price_refund_hours'] = 'نافذة الاسترداد (بالساعات)';
$string['price_refund_hours_help'] = 'المدة المتاحة لمن دفع بهذا السعر لاسترداد المبلغ بنفسه، محسوبة من لحظة اكتمال الدفع. اتركها فارغة لاتباع سياسة الاسترداد العامة للموقع. وأدخل 0 لمنع الاسترداد التلقائي عند هذا السعر، فيضطر المشتري عندها إلى تقديم طلب يبتّ فيه أحد الموظفين.';
...
$string['show_method_picker'] = 'السؤال عن وسيلة الدفع';
$string['show_method_picker_desc'] = 'عرض وسائل الدفع على المشتري قبل إتمام الشراء. الخيار متوقف افتراضياً، وعندها يتم الدفع مباشرة بأول وسيلة في قائمة الأولوية — ولهذا لا تظهر سوى البطاقات. فعّل هذا الخيار لعرض فوري وميزا والمحافظ إلى جانب البطاقات. ولا تظهر الشاشة إلا عندما يقدّم المزود أكثر من وسيلة فعلاً، فلا تتحول إلى نقرة بلا فائدة.';
...
$string['price_refund_feetype'] = 'نوع رسوم الاسترداد';
