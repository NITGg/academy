...
$string['refund_feepercent'] = 'رسوم الاسترداد الافتراضية (%)';
$string['refund_feepercent_desc'] = 'نسبة مئوية من المبلغ المدفوع تُحتجز عند تنفيذ الاسترداد. تُستخدم عندما لا يحدد المقرر أو الخطة رسوماً خاصة. وهي نسبة مئوية لا مبلغاً ثابتاً عن قصد: فرقم واحد يغطي كل العملات التي يُسعَّر بها العنصر، ويتبع المبلغ المحصَّل فعلاً، فالخصم الذي ينصّف السعر ينصّف الرسوم. القيمة 0 تعني استرداداً كاملاً.';
