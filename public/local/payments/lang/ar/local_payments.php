...
$string['refund_err_nolongercompleted'] = 'هذه الدفعة لم تعد مكتملة (حالتها الآن: {$a})، لذا لا يمكن إرسال الاسترداد. ارفض الطلب بدلاً من ذلك واذكر السبب في الملاحظة.';
