...
$string['auth_mode_desc'] = 'Use the HASH API key: it is what the v2 payment endpoints accept. The OAuth option issues tokens correctly, but those tokens are rejected by the payment API (verified against a live account) &mdash; they belong to Fawaterk's newer Integrations API. Only switch to OAuth if Fawaterk confirms the payment endpoints now accept it.';
