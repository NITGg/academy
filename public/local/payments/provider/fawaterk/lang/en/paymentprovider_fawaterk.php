...
$string['auth_heading_desc'] = 'How Moodle authenticates its calls to the Fawaterk API. Both credential sets come from the Fawaterk dashboard: <b>Integrations</b> in the left menu. Sandbox and live are separate accounts with separate credentials.';
$string['auth_mode'] = 'Authentication method';
$string['auth_mode_desc'] = 'OAuth 2.0 is the method Fawaterk recommends and the one their Integrations page issues credentials for. The static key is the older style and is kept only for accounts that have no OAuth client.';
$string['auth_mode_oauth'] = 'OAuth 2.0 client credentials (recommended)';
$string['auth_mode_apikey'] = 'Static HASH API key (legacy)';
