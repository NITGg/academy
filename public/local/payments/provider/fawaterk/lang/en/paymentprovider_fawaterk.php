...
$string['currencies_desc'] = 'Comma-separated currency codes Fawaterk may be offered for. The buyer is charged in whichever currency the order uses, so multi-currency pricing works normally. Note that Fawaterk reports every transaction back converted into EGP, its settlement currency &mdash; that is a reporting figure only and is handled. Narrow this list if the account genuinely cannot take one of these; a course priced in a currency that is not listed falls through to another provider.';
...
$string['countries_desc'] = 'Comma-separated ISO country codes this Fawaterk account will be offered for. A buyer whose country is not listed is routed to another provider instead. Leave the default unless the account covers somewhere else.';
