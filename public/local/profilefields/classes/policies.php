 ...
 * academy wants one checkbox on the form itself, so this class reads the policy
 * documents tool_policy holds and turns them into the links for that checkbox. The
 * documents stay authored and versioned in tool_policy; only the consent gesture
 * moves onto the form.
 *
...
class policies {
    ...
    public static function consent_label(): string {
        ...
        // "I agree to X and Y" - join with a localisable separator and connector.
