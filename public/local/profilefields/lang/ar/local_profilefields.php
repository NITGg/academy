...
// إضافات صفحة «عن الأكاديمية» (AC-4.21.1): الواجهة والحقائق والمبادئ والمحطات.
$string['abouthero'] = 'الصورة والفيديو';
$string['abouthero_desc'] = 'ما تُفتتح به الصفحة بجوار العنوان. اضبط صورة أو فيديو أو الاثنين معًا — مع الاثنين تُعرض الصورة وعليها زر تشغيل، ولا يبدأ الفيديو إلا عند الضغط عليه.';
$string['aboutheroimage'] = 'الصورة';
$string['aboutheroimage_help'] = 'صورة واحدة تُعرض بجوار العنوان باللغتين. الأفضل صورة عرضية بدقة 1200 × 800 بكسل على الأقل؛ تُقصّ في الصفحة إلى إطار 5:4.';
$string['aboutherovideo'] = 'رابط الفيديو';
$string['aboutherovideo_help'] = 'رابط يوتيوب أو فيميو كما تشاركه عادةً (رابط المشاهدة أو المشاركة أو التضمين)، أو رابط مباشر لملف ‎.mp4‎. اتركه فارغًا بلا فيديو.';
$string['aboutherovideoinvalid'] = 'هذا ليس رابط فيديو تستطيع الصفحة تشغيله. استخدم رابط يوتيوب أو فيميو، أو رابطًا مباشرًا لملف ‎.mp4‎.';
$string['abouttagline'] = 'السطر التعريفي ({$a})';
$string['abouttagline_help'] = 'سطر قصير واحد يُطبع فوق العنوان — ما هي الأكاديمية في نَفَس واحد. حتى 80 حرفًا. اتركه فارغًا بلا سطر.';
$string['aboutlede'] = 'المقدمة ({$a})';
$string['aboutlede_help'] = 'الجملتان أو الثلاث تحت العنوان التي يقرؤها الزائر قبل أن يقرر إكمال القراءة. نص عادي حتى 400 حرف. اتركه فارغًا بلا مقدمة.';
$string['aboutfacts'] = 'الحقائق';
$string['aboutfacts_desc'] = 'شريط الأرقام تحت الصورة — سنة التأسيس، عدد المتدربين، عدد الدورات، الاعتماد. كل حقيقة قيمة وتسمية قصيرة. حتى {$a}؛ اترك القيمة فارغة لحذف الحقيقة.';
$string['aboutfactno'] = 'الحقيقة {no}';
$string['aboutfactvalue'] = 'القيمة';
$string['aboutfactlabel'] = 'التسمية ({$a})';
$string['aboutaddfact'] = 'إضافة حقيقة';
$string['aboutpillars'] = 'ما نؤمن به';
$string['aboutpillars_desc'] = 'مبادئ الأكاديمية، تُعرض شبكةً من ثلاثة — لكل مبدأ أيقونة وعنوان وجملة أو اثنتان. حتى {$a}.';
$string['aboutpillarno'] = 'المبدأ {no}';
$string['aboutpillaricon'] = 'الأيقونة';
$string['aboutpillaricon_help'] = 'أيقونة من Font Awesome 6، مثل ‎"fa-solid fa-gears"‎ أو ‎"fa-solid fa-graduation-cap"‎ أو فقط ‎"industry"‎. تصفح الأيقونات المجانية على ‎fontawesome.com/search?o=r&m=free‎. اتركها فارغة لعلامة صح.';
$string['aboutpillartitle'] = 'العنوان ({$a})';
$string['aboutpillartext'] = 'النص ({$a})';
$string['aboutaddpillar'] = 'إضافة مبدأ';
$string['aboutmilestones'] = 'المحطات';
$string['aboutmilestones_desc'] = 'تاريخ الأكاديمية، صف لكل سنة، بالترتيب المكتوب هنا. حتى {$a}.';
$string['aboutmilestoneno'] = 'المحطة {no}';
$string['aboutmilestoneyear'] = 'السنة';
$string['aboutmilestonetitle'] = 'العنوان ({$a})';
$string['aboutmilestonetext'] = 'النص ({$a})';
$string['aboutaddmilestone'] = 'إضافة محطة';
$string['aboutremoverow'] = 'إزالة';

$string['aboutbrowsecourses'] = 'تصفّح الدورات';
$string['aboutcontactus'] = 'اتصل بنا';
$string['aboutplayvideo'] = 'تشغيل الفيديو';
$string['aboutstory'] = 'قصتنا';
$string['aboutpillarsheading'] = 'ما نؤمن به';
$string['aboutmilestonesheading'] = 'المحطات';
$string['aboutctatitle'] = 'مستعد لبدء التعلّم؟';
$string['aboutctatext'] = 'تصفّح الدورات، جرّب درسًا، والتحق حين تكون جاهزًا.';
