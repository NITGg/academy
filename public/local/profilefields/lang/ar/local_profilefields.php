...
$string['ipmatchnogeoip'] = 'يتطلب هذا مصدر geo-IP. لا يوجد مصدر مُعَدّ بعد، لذا يُتجاوَز الفحص (لا يُمنَع أحد) حتى تضبط واحدًا من <a href="{$a}">الموقع الجغرافي ← البحث عن عنوان IP</a>.';
