...
$string['aboutherovideo'] = 'الفيديو';
$string['aboutherovideo_help'] = 'ملف فيديو واحد — ‎.mp4‎ (H.264) يعمل في كل مكان؛ ‎.webm‎ و‎.ogv‎ يعملان أيضًا. يُشغَّل في مشغّل الصفحة نفسها، فاجعله قصيرًا وضمن حد الرفع في الموقع (ملف ‎.mp4‎ لدقيقة أو اثنتين يكون عادةً 20-60 ميجابايت). اتركه فارغًا بلا فيديو.';
