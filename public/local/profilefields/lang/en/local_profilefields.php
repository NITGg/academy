...
// The account screen - WF-5.1 to WF-5.6.
$string['accounttitle'] = 'My account';
$string['navprofile'] = 'Profile';
$string['navsecurity'] = 'Security';
...
$string['namehelp'] = 'The name on issued certificates is the name held at the moment of issue.';
$string['changeemailbutton'] = 'Change';
$string['changeemailtitle'] = 'Change email address';
...
// The About page's extras (AC-4.21.1): hero, facts, pillars, milestones.
$string['abouthero'] = 'Picture and video';
$string['abouthero_desc'] = 'What the page opens with, beside the title. Set a picture, a video, or both - with both, the picture is shown with a play button and the video starts only when it is pressed.';
$string['aboutheroimage'] = 'Picture';
$string['aboutheroimage_help'] = 'One picture, shown beside the title in both languages. A landscape photo of at least 1200 × 800 pixels looks best; it is cropped to a 5:4 frame on the page.';
$string['aboutherovideo'] = 'Video address';
$string['aboutherovideo_help'] = 'A YouTube or Vimeo link as you would share it (watch, share or embed address), or a direct link to an .mp4 file. Leave empty for no video.';
$string['aboutherovideoinvalid'] = 'This is not a video address the page can play. Use a YouTube or Vimeo link, or a direct link to an .mp4 file.';
$string['abouttagline'] = 'Tagline ({$a})';
$string['abouttagline_help'] = 'One short line printed above the title - what the academy is, in a breath. Up to 80 characters. Leave empty for none.';
$string['aboutlede'] = 'Introduction ({$a})';
$string['aboutlede_help'] = 'The two or three sentences under the title that a visitor reads before deciding whether to read the rest. Plain text, up to 400 characters. Leave empty for none.';
$string['aboutfacts'] = 'Facts';
$string['aboutfacts_desc'] = 'The strip of figures under the picture - founded in, learners so far, courses, accreditation. Each is a value and a short label. Up to {$a}; leave the value empty to remove a fact.';
$string['aboutfactno'] = 'Fact {no}';
$string['aboutfactvalue'] = 'Value';
$string['aboutfactlabel'] = 'Label ({$a})';
$string['aboutaddfact'] = 'Add a fact';
$string['aboutpillars'] = 'What we stand for';
$string['aboutpillars_desc'] = 'The academy\'s principles, drawn as a grid of three - each with an icon, a heading and a sentence or two. Up to {$a}.';
$string['aboutpillarno'] = 'Principle {no}';
$string['aboutpillaricon'] = 'Icon';
$string['aboutpillaricon_help'] = 'A Font Awesome 6 icon, for example "fa-solid fa-gears", "fa-solid fa-graduation-cap" or just "industry". Browse the free icons at fontawesome.com/search?o=r&m=free. Leave empty for a tick.';
$string['aboutpillartitle'] = 'Heading ({$a})';
$string['aboutpillartext'] = 'Text ({$a})';
$string['aboutaddpillar'] = 'Add a principle';
$string['aboutmilestones'] = 'Milestones';
$string['aboutmilestones_desc'] = 'The academy\'s history, one row per year, shown in the order typed here. Up to {$a}.';
$string['aboutmilestoneno'] = 'Milestone {no}';
$string['aboutmilestoneyear'] = 'Year';
$string['aboutmilestonetitle'] = 'Heading ({$a})';
$string['aboutmilestonetext'] = 'Text ({$a})';
$string['aboutaddmilestone'] = 'Add a milestone';
$string['aboutremoverow'] = 'Remove';

$string['aboutbrowsecourses'] = 'Browse courses';
$string['aboutcontactus'] = 'Contact us';
$string['aboutplayvideo'] = 'Play the video';
$string['aboutstory'] = 'Our story';
$string['aboutpillarsheading'] = 'What we stand for';
$string['aboutmilestonesheading'] = 'Milestones';
$string['aboutctatitle'] = 'Ready to start learning?';
$string['aboutctatext'] = 'Browse the catalogue, preview a lesson, and enrol when you are ready.';
