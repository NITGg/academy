...
$string['aboutherovideo'] = 'Video';
$string['aboutherovideo_help'] = 'One video file - .mp4 (H.264) plays everywhere; .webm and .ogv also work. It plays in the page\'s own player, so keep it short and under the site\'s upload limit (an .mp4 of a minute or two is usually 20-60 MB). Leave empty for no video.';
