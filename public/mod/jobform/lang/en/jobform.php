...
$string['resendnote'] = 'You sent this form on {$a}. You can still update it; the reviewer sees the latest version and keeps the earlier ones.';
$string['updateform'] = 'Update';
