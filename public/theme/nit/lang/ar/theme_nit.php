...
$string['categorystyles_groupmismatch'] = '{$a} — مخالفة للوضع، يُرجى تغييرها';
...
$string['sitestyles_desc'] = 'اختر مجموعة ألوان الهوية التي يستخدمها الموقع في كل وضع عرض. يبدّل زر الوضع الفاتح/الداكن في شريط التنقّل بين الوضعين — وهو لا يحمل لوحة ألوان خاصة به، بل يختار إحدى المجموعات أدناه، فيرى الزائر عند الضغط عليه الألوان نفسها التي ضبطتها في تبويب ألوان الهوية. لا يعرض كل وضع إلا المجموعات المُصمَّمة له، فينتقل الزر دائمًا بين لوحة فاتحة وأخرى داكنة. اجعل للوضعين مجموعتين مختلفتين؛ فإن تطابقتا لم يغيّر الزر شيئًا ولن يظهر. أمّا الصفحات داخل تصنيف له أنماطه الخاصة فتستخدم تلك الأنماط، وينتقل الزر بين زوج ذلك التصنيف.';
