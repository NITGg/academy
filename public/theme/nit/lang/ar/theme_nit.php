...
<li>السطر <b>الذي يبدأ بشرطة</b> صفحة داخل تلك المجموعة: <code>-الاسم الإنجليزي|الاسم العربي|الرابط</code></li>
</ul>
<p>الرابط صفحة في هذا الموقع (<code>/my/courses.php</code>) أو عنوان كامل. اكتب اسمًا واحدًا فقط ويُستخدم للغتين. صفحات إدارة الموقع وشاشات الإدارة تظهر فقط لمن يحق له فتحها؛ وأي رابط آخر يظهر للجميع (أضف <code>|loggedin</code> في آخر السطر لقصره على المسجلين). اترك المربع فارغًا لإخفاء كل المجموعات. مثال:</p>
