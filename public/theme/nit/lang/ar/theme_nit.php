...
// إعدادات قائمة الترس — تُضاف إلى صفحة «إعدادات السمة المتقدمة» الأساسية.
$string['gearmenu'] = 'قائمة الترس في شريط التنقل';
$string['gearmenu_desc'] = 'أيقونة الترس في شريط التنقل تفتح مجموعتين من الروابط: <em>التنقل</em> (مقرراتي، إدارة الموقع) و<em>الإدارة</em> (الكوبونات والعروض والاشتراكات وبقية شاشات الإدارة). لكل مجموعة اختر أدناه: هل تظهر، وما اسمها، وأي الصفحات تُدرج فيها. الصفحة لا تظهر أبدًا إلا لمن يحق له فتحها، فالطالب لا يرى شاشات الإدارة مهما وُضعت هنا. مفتاح وضع التحرير، لمن يملكه، يوضع بعد المجموعة الأولى.';
$string['gearmenushow'] = 'إظهار مجموعة «{$a}»';
$string['gearmenushow_desc'] = 'أزل العلامة لإخفاء المجموعة كلها، بعنوانها وصفحاتها، من قائمة الترس.';
$string['gearmenuname'] = 'اسم مجموعة «{$a}»';
$string['gearmenuname_desc'] = 'العنوان الذي يظهر فوق صفحات المجموعة. اتركه فارغًا لاستخدام «{$a}» (مترجمًا لكل لغة). ولكتابة اسم من عندك باللغتين اكتبه بالشكل <code>{mlang en}Name{mlang}{mlang ar}الاسم{mlang}</code>.';
$string['gearmenupages'] = 'صفحات مجموعة «{$a}»';
$string['gearmenupages_desc'] = 'ضع علامة على الصفحات التي تُدرج تحت هذه المجموعة، بالترتيب المعروض. يمكن وضع الصفحة في المجموعتين معًا أو في أيٍّ منهما.';
