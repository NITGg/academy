...
$string['loginbackgroundimage'] = 'صورة صفحة تسجيل الدخول';
$string['loginbackgroundimage_desc'] = 'الصورة التي تظهر بجانب بطاقتَي تسجيل الدخول وإنشاء الحساب. اترك الحقل فارغًا للإبقاء على الصورة الافتراضية المرفقة مع مودل (والتي تحمل عبارة «صورة مولّدة بالذكاء الاصطناعي»). يُفضَّل استخدام صورة عريضة أفقية؛ فهي تُقتَص من المنتصف لتملأ اللوحة، لذا أبقِ العناصر المهمة بعيدًا عن الحواف.';
