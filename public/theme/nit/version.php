...
$plugin->version   = 2026091501;        // YYYYMMDDXX — Navbar "Log in" carries the page to come back to (nitreturn= → $SESSION->wantsurl via after_config); footer login line agrees.
