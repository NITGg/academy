...
class block_cocoon_course_categories extends block_base {
    ...
    function get_content() {
        ...
        <div class="text-center mb-2">
          <h2 data-ccn="title" class="mt0" data-ccn-c="color_title" data-ccn-co="content" style="color:'.$this->content->color_title.';">'.format_text($this->content->title, FORMAT_HTML, array('filter' => true)).'</h2>
      	  <p data-ccn="subtitle" data-ccn-c="color_subtitle" data-ccn-co="content" style="color:'.$this->content->color_subtitle.'; font-weight: 400;font-size: 2rem;">'.format_text($this->content->subtitle, FORMAT_HTML, array('filter' => true)).'</p>
        </div>
        ';
        ...
        <div class="image_box_1 wow bounceInRight"><img src="https://academy2022.nitg-eg.com/services_imgs/talepa.webp" alt="img1"></div>
          ...
          if ($category->parent == 0) {
            if ($DB->record_exists('course_categories', array('id' => $category->id))) {
              ...
              $this->content->text .='
                ...
                <a class="category_name_box wow bounceIn" href="'.$ccnCategory->categoryUrl.'">
        ...
        <div class="image_box_2 wow bounceInLeft"><img src="https://academy2022.nitg-eg.com/services_imgs/talep.webp" alt="img1"></div>
        </div>
        ';
