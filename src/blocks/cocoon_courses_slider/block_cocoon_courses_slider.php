...
class block_cocoon_courses_slider extends block_base {
    ...
    public function get_content() {
        ...
        .tc_content a h5 {color: white;}
        .tc_footer {
          background: linear-gradient(180deg, #0E2647 0%, rgba(14, 38, 71, 0.00) 100%);
        }
        </style>';
            ...
            <section class="popular-courses bgc-thm2">
          		<div class="container-fluid style2">
                    ...
                    // if(!empty($this->content->title)){
                      $this->content->text .='<h2 class="mt0 color-white" data-ccn="title">'.format_text($this->content->title, FORMAT_HTML, array('filter' => true)).'</h2>';
                    // }
                    if(!empty($this->content->subtitle)){
                      $this->content->text .='<p class="color-white; font-weight: 400;font-size: 2rem;" data-ccn="subtitle">'.format_text($this->content->subtitle, FORMAT_HTML, array('filter' => true)).'</p>';
                    }
                    $this->content->text .='
          					</div>
          				</div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 offset-lg-3">
        <div class="main-title text-center">';
        // if(!empty($this->content->title)){
          $this->content->text .='<h2 class="mb0 mt0" data-ccn="title">'. format_text($this->content->title, FORMAT_HTML, array('filter' => true)) .'</h2>';
        // }
        // if(!empty($this->content->subtitle)){
          $this->content->text .='<p data-ccn="subtitle" style="font-weight: 400;font-size: 2rem;">'.format_text($this->content->subtitle, FORMAT_HTML, array('filter' => true)).'</p>';
        // }
       $this->content->text .='
        </div>
      </div>
