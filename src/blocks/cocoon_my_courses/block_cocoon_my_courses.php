...
';
        ...
        if ($total_courses == 0) {
            ...
            <div class="col-12 text-center" style="padding: 40px 15px; background: #f8f9fa; border-radius: 10px; border: 1px dashed #ced4da; margin-bottom: 30px; width: 100%;">
                ...
                <h4 style="color: #495057; font-weight: 600; margin-bottom: 10px;">' . get_string('nocourses', 'block_cocoon_my_courses') . '</h4>
                <p style="color: #6c757d; margin-bottom: 0;">' . get_string('nocourses_desc', 'block_cocoon_my_courses') . '</p>
            </div>';
        } else {
