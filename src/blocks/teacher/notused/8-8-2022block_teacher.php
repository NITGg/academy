    ...
    function get_all_courses($user, $teacher ,$lang='')
{
                ...
                <div class="col-sm-12 col-md-4 col-lg-4 mt-sm-2 mt-md-2 mt-lg service-area">
                    ...
                    <div class="row">
                       ...
                       ';
                        ...
                        <a href="https://www.youtube.com/user/omaroma100/videos" target="_blank"><i class="bi bi-youtube"></i></a>
                    </div>
                    <div class="iconContainer rounded-circle mx-1">
                        ...
                        <p class="p">
                            ...
                            <input type="text " style="display:none;" id="editFacebook" class="form-control">| 
                            <a href="https://www.youtube.com/user/omaroma100/videos" target="_blank">Youtube</a>  |
    ...
    if($isadmin||$_SESSION['userdata']==$USER->id){
        $this->content->text .= ' <div class="container-fluid px-5" id="sectionThree">
            ...
            <div class="carousel mx-5" data-flickity >
          ';
            foreach($courses as $course) {
                // $this->content->text .='dsf'.$course->course_id;
                $data=$DB->get_record('course', array('id' => $course->course_id));
                    ...
                    <img src="'.$this->get_course_image($course).'">
                        ...
                        <div class="course-content py-4">
                            ...
                            <button class="rounded-pill mt-3">
                                <a href="' . $CFG->wwwroot . '/course/view.php?id=' . $course->id . '">Enter</a>
                            </button>
                        </div>
                    </div>
                    </div>
    ';
        ...
        elseif($isStudent){
            ...
            $this->content->text .= ' <div class="container-fluid px-5" id="sectionThree">
            <div class="text-center"><h2>Your Courses</h2></div>
            <div class="carousel mx-5" data-flickity >
          ';
            foreach($coursesStudent->data as $course) {
                ...
                $this->content->text .= '    <div class=" carousel-cell col-sm-12 col-md-4 my-3 mx-auto">
                    <div class="course">
                    <img src="'.$course->image.'?token=4f9205aa0ab740c6def0a6d0ba898605">
                        ...
                        <div class="text-center mt-3 px-2"> <h2>' . $course->course_name . '</h2></div>
                        <div class="course-content py-4">
                            <p>
                             '.format_text($course->course_desc).'
                            </p>
                            <button class="rounded-pill mt-3">
                                <a href="' . $CFG->wwwroot . '/course/view.php?id=' . $course->course_id . '">Enter</a>
                            </button>
                        </div>
                    </div>
                    </div>
        ...
        $( document ).ready(function() {
           var direction= $("body").css("direction");
            ...
            $("#editsectionOnePrag").blur(function(e){
                ...
                if(val.includes("Click here to edit")){
                val = "";
                $("#sectionOnePrag").text("Click here to edit");
                }
                else{
            ...
            $("#editsection1left").blur(function(e){
                ...
                if(val.includes("Click here to edit")){
                val = "";
                $("#section1left").text("Click here to edit");
                }
                else{
            ...
            $("#editsectionOneHead").blur(function(e){
                ...
                if(val.includes("Click here to edit")){
                val = "";
                $("#sectionOneHead").text("Click here to edit");
                }
                else{
            ...
            $("#editDivOne").blur(function(e){
                ...
                if(val.includes("Click here to edit")){
                    val = "";
                    $("#divOne").text("Click here to edit");
            ...
            $("#editDivTwo").blur(function(e){
                ...
                if(val.includes("Click here to edit")){
                    val = "";
                    $("#divTwo").text("Click here to edit");
            ...
            $("#editDivThree").blur(function(e){
                ...
                if(val.includes("Click here to edit")){
                    val = "";
                    $("#divThree").text("Click here to edit");
            ...
            $("#editDivFour").blur(function(e){
                ...
                if(val.includes("Click here to edit")){
                    val = "";
                    $("#divFour").text("Click here to edit");
            ...
            $("#editDivFive").blur(function(e){
                ...
                if(val.includes("Click here to edit")){
                    val = "";
                    $("#divFive").text("Click here to edit");
