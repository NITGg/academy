...
$records = $DB->get_records('course_promo_videos', array('course_id' => $id));
...
if(!$records) { ?>
  <!-- upload video -->
  <div class="my-form" id="myUploadForm">
  <form id="videoUploadForm" action="./upload_promo.php" enctype="multipart/form-data" method="post">
  ...
  <?php
    ...
    foreach ($videoRecords as $record) {
        ...
        if ($PAGE->user_allowed_editing()) {
            echo '
        <a href="./delete_video.php?video_id_to_delete=' . $record->url_name . '&course_id=' . $id . '" style="color: #B21F61;">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        form.addEventListener('submit', async e => {
            ...
            xhr.open('POST', 'upload_promo.php', true);
