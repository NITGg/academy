    ...
    public function course_section_cm_name_title(cm_info $mod, $displayoptions = array())
    {
        ...
        if ($mod->uservisible) {
            ...
            .content' . $mod->id . '{
                ...
                height: auto;
                text-align: center;
                background-image: url(../services_imgs/add_code_background.webp);
            ...
            #addCode2' . $mod->id . ':hover {
                color: white;
                scale: 1.01;
            }
        </style>
                <div class="content' . $mod->id . ' myDivs " >
                <div onclick="" class="close-btn" id="close-btn' . $mod->id . '">
                <i class="fa fa-times" aria-hidden="true"></i>
                </div>
                <br><br>
                <h1 class="head1">انضم للأكاديمية وتعلم بذكاء...</h1>
                <h1 class="head2">Code</h1>
                <div class="message">please add code to open it</div>
                ...
                <input type="text" class="form-control" placeholder="Add a Code" id="codeGroup2' . $mod->id . '" required>
                <button class="btn btn-primary " id="addCode2' . $mod->id . '">' . get_string("courseAddCode", "theme_edumy") . '</button>
