...
if ($isadmin || $manager == 1) {
    if ($course != "all") {
        $activity = $DB->get_record('activities_control', array('course' => $course, 'teacher_id' => $teacher_id));
    ...
    <div class="form-check  ">
    <input type="checkbox" name="enable_file"   class="form-check-label"  id="checked4">
    <label class="form-check-label" >
    ' . get_string('enable_file', 'theme_edumy') . '
      </label>
    </div>
    <div class="form-check  ">
    ...
    <a class="btn btn-success" href="' . $CFG->wwwroot . '/forms/bbb.php">' . get_string('back', 'theme_edumy') . '</a>
        ...
        if (isset($_POST['button1'])) {
            ...
            if (!empty($activity)) {
                ...
                $DB->update_record('activities_control', $ins1);
            }
            if (empty($activity)) {
                $ins1->course = $course;
                ...
                $DB->insert_record('activities_control', $ins1);
            }
