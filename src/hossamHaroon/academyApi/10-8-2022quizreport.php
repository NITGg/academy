...
function course_report_quiz_user($courseid, $user)
{
   ...
   ");
	...
	// 	}
	// }
	return json_encode(['quiz' => $quizData, 'exam' => $examData, 'page' => $pageResult, 'file' => $fileResult, 'lesson' => $codeResult,'homework' => $homeworkResult,'summary' => $summaryResult,'revision' => $revisionResult]);
}
