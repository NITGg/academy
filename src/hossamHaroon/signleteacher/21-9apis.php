...
function aboutInfo()
{
    ...
    على كل حال ... أهلا بكم  في هذا الملتقى التعليمي المتميز  لنتعاون جميعا من خلال منظومة إلكترونية متخصصة للوصول إلى أعلى الدرجات في مادة اللغة العربية مع الأستاذ فريد شوقي.
    </p>
