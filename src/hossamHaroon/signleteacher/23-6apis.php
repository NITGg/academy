    ...
    try {
        ...
        if (!empty($array)) {
            ...
            if ($function == 'get_user_courses') {
                ...
                //     CURLOPT_URL => 'https://academy.nitg-eg.com/signleteacher/apis.php?function=change_password&token='.$token.'&oldpassword='.$oldPassword.'&newpassword='.$newPassword,
                ...
                //     // CURLOPT_POSTFIELDS => array('oldpassword' => '123456', 'newpassword' =>  '1234567'),    
                // ));
            ...
            elseif ($function == 'edit_user') {
                ...
                $user = new User();
                echo $user->edit_user_data($userID, $fname, $lname, $phone1, $phone2, $city, $center, $school);
            }
...
return file_get_contents("php://input");
    ...
    function edit_user_data($userid, $firstname = null, $lastname = null, $phone1 = null, $phone2 = null, $city = null, $center = null, $school = null)
    {
        global $DB;
        try {
            $user = $DB->get_record('user', array('id' => $userid));
