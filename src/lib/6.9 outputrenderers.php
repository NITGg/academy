    ...
    public function header()
    {
       ...
       a.mobileBrand {
        ...
        $header .= "<style>
          ...
          .header{background-color:" . $record->button_color . " !important;}
          ...
          a#prev-activity-link :hover , a#next-activity-link :hover, a.ccn-mod-forum-btn:hover, a.feedbackBtn:hover, a.reserveBtn:hover{
            background-color:" . $record->hover . " !important;
            color:" . $record->color . " !important  ;
            border:2px solid " . $record->hover . " !important;
          }
