...
class core_renderer extends renderer_base {
    ...
    public function header()
    {
        ...
        // $record=$DB->get_record('teacher_logo',array('teacher_id'=>$id));
        // $record1=$DB->get_record('teacher_logo',array('teacher_id'=>$USER->id));
        $teacher = $DB->get_records_sql("SELECT  u.id as id ,u.firstname as firstname ,u.lastname as lastname FROM mdl_course c LEFT OUTER JOIN mdl_context cx ON c.id = cx.instanceid LEFT OUTER JOIN mdl_role_assignments ra ON cx.id = ra.contextid AND ra.roleid = '3' LEFT OUTER JOIN mdl_user u ON ra.userid = u.id WHERE cx.contextlevel = '50' AND c.id= '$COURSE->id'");
        $getusers = $DB->get_records_sql("SELECT * FROM mdl_user WHERE id= '$USER->id'");
        $getCourseName = $DB->get_records_sql("SELECT * FROM mdl_course WHERE id='$COURSE->id'");
        foreach ($getusers as $userP) {
        }
        $nopicSrc = $CFG->wwwroot . '/theme/edumy/images/teachers/user.png';
        $user_data = "";
      
        if (strpos($_SERVER['REQUEST_URI'], 'login')||strpos($_SERVER['REQUEST_URI'], 'confirm')||strpos($_SERVER['REQUEST_URI'], 'signup')) {
            $id = $_GET["id"];
            $_SESSION['userdata'] = $id;
            $user_data = $_SESSION['userdata'];
            setcookie('userdata', $id, time() + (86400 * 30), "/"); // 86400 = 1 day
            // if($id==14 || $id==15){
            //     $conf=$DB->get_record('config',array('name'=>'lang'));
            //     $upd = new stdClass();
            //     $upd->id=$conf->id;
            //     $upd->value='ar';
            //     $DB->update_record('config',$upd);
            // }
            if ($user_data == null) {
                     $admins = get_admins();
            $isadmin = false;
            ...
            if($isadmin){
                ...
                $teacherId = $DB->get_record("user", array("id" => $id));
                ...
                var x = document.getElementsByClassName("logo1");
                var y = document.getElementsByClassName("logo2");
                var z = document.getElementsByClassName("nav_logo_img");
                var name= document.querySelector("a.navbar_brand span").innerText;
                document.querySelector("a.navbar_brand span").innerText="' . $teacherId->firstname . ' ' . $teacherId->lastname . '";
                document.querySelector("a.mobileBrand span").innerText="' . $teacherId->firstname . ' ' . $teacherId->lastname . '";
                document.querySelector("h4.breadcrumb_title").innerText="' . $teacherId->firstname . ' ' . $teacherId->lastname . '";
                var i;
                for (i = 0; i < y.length; i++) {
                    y[i].src = "';
                    $header .=  $this->upload_user_image($teacherId->id);
                // if($teacherId->url == null){
                //     $header .= $nopicSrc;

                // }else{
                //     $header .= $CFG->wwwroot.'/theme/edumy/images/teachers/'.$teacherId->url;
                ...
                // }else{
                //     $src= $CFG->wwwroot.'/theme/edumy/images/teachers/'.$teacherId->url;
        ...
        if ($CFG->wwwroot) {
            ...
            // var_dump($user_data);
            setcookie('userdata', $user_data, time() + (86400 * 30), "/"); // 86400 = 1 day

            if ($user_data == null) {
            } else {
                $teacherId = $DB->get_record("user", array("id" => $user_data));
        ...
        if (strpos($_SERVER['REQUEST_URI'], 'course')) {
            foreach ($teacher as $teacherId) {
                // $logo=$DB->get_record('teacher_logo',array('teacher_id'=>$teacherId->id));
                $header .= '<script>
            var x = document.getElementsByClassName("logo1");
            var y = document.getElementsByClassName("logo2");
            var z = document.getElementsByClassName("nav_logo_img");
            ...
            document.querySelector("a.navbar_brand span").innerText="' . $teacherId->firstname . ' ' . $teacherId->lastname . '";
            document.querySelector("a.mobileBrand span").innerText="' . $teacherId->firstname . ' ' . $teacherId->lastname . '";
            // document.querySelector("h4.breadcrumb_title").innerText="' . $COURSE->fullname . '";
            ...
            for (i = 0; i < z.length; i++) {
               ...
               console.log(document.querySelectorAll(".section-modchooser-link").length);
            </script>';
            }
        }
        if (strpos($_SERVER['REQUEST_URI'], 'quiz') || strpos($_SERVER['REQUEST_URI'], 'forum') || strpos($_SERVER['REQUEST_URI'], 'resource') || strpos($_SERVER['REQUEST_URI'], 'page') || strpos($_SERVER['REQUEST_URI'], 'assign')) {
            $course_module = $_SESSION['cmid'];

            $course = $DB->get_record("course_modules", array("id" => $course_module));
            //echo $course->course;
            $teacher = $DB->get_records_sql("SELECT  u.id as id ,u.firstname as firstname ,u.lastname as lastname FROM mdl_course c LEFT OUTER JOIN mdl_context cx ON c.id = cx.instanceid LEFT OUTER JOIN mdl_role_assignments ra ON cx.id = ra.contextid AND ra.roleid = '3' LEFT OUTER JOIN mdl_user u ON ra.userid = u.id WHERE cx.contextlevel = '50' AND c.id= '$course->course'");
            foreach ($teacher as $teacherId) {
                // $logo=$DB->get_record('teacher_logo',array('teacher_id'=>$teacherId->id));
            ...
            var name= document.querySelector("a.navbar_brand span").innerText;
            document.querySelector("div.main_logo_home2 span").innerText="' . $teacherId->firstname . ' ' . $teacherId->lastname . '";
            document.querySelector("a.navbar_brand span").innerText="' . $teacherId->firstname . ' ' . $teacherId->lastname . '";
        ...
        //         if(strpos($_SERVER['REQUEST_URI'],'teacher')){
        //             $header .='<script>
        //             var x = document.getElementsByClassName("logo1");
        //             var i;
        //             for (i = 0; i < x.length; i++) {
        ...
        if (strpos($_SERVER['REQUEST_URI'], 'join_student')) {
            $course = $_GET['course'];
            ...
            foreach ($teachers as $teach) {
                $teacher = $DB->get_record('user', array('id' => $teach->id));
                $header .= '<script>
        var x = document.getElementsByClassName("logo1");
        var y = document.getElementsByClassName("logo2");
        var z = document.getElementsByClassName("nav_logo_img");
                
        document.querySelector("a.navbar_brand span").innerText="' . $teacher->firstname . ' ' . $teacher->lastname . '";
        document.querySelector("a.mobileBrand span").innerText="' . $teacher->firstname . ' ' . $teacher->lastname . '";
        // document.querySelector("h4.breadcrumb_title").innerText="' . $course_data->fullname . '";
        ...
        for (i = 0; i < x.length; i++) {
            x[i].src = "';
                ...
                // }else{
                //     $header .= $CFG->wwwroot.'/theme/edumy/images/teachers/'.$teacher->url;
       ...
       a.mobileBrand {
        ...
        if (strpos($_SERVER['REQUEST_URI'], 'all_bbb_data')) {
       ...
       a.mobileBrand {
        ...
        if ($isStudent) {
            ...
            if (strpos($_SERVER['REQUEST_URI'], 'teacher')) {
                ...
                $teacher = $DB->get_record("user", array('id' => $id));
                $header .= '<script>
                var x = document.getElementsByClassName("logo1");
                var y = document.getElementsByClassName("logo2");
                var z = document.getElementsByClassName("nav_logo_img");
                ...
                document.querySelector("a.navbar_brand span").innerText="' . $teacher->firstname . ' ' . $teacher->lastname . '";
                document.querySelector("a.mobileBrand span").innerText="' . $teacher->firstname . ' ' . $teacher->lastname . '";
                // document.querySelector("h4.breadcrumb_title").innerText="' . $teacher->firstname . ' ' . $teacher->lastname . '";
        ...
        if (strpos($_SERVER['REQUEST_URI'], 'view_session')) {
            $course = $_GET['course'];
            ...
            ';
            $course_data = $DB->get_record("course", array('id' => $course));
            $teacher = $DB->get_record("user", array('id' => $teacher));
            $header .= '<script>
            var x = document.getElementsByClassName("logo1");
            var y = document.getElementsByClassName("logo2");
            var z = document.getElementsByClassName("nav_logo_img");
            ...
            if (strpos($_SERVER['REQUEST_URI'], 'course')) {
                ...
                // document.querySelector("h4.breadcrumb_title").innerText="' . $userP->firstname . ' ' . $userP->lastname . '";
                </script>
                ';
            }
            $header .= '<script>
            ...
            document.querySelector("a.navbar_brand span").innerText="' . $userP->firstname . ' ' . $userP->lastname . '";
            document.querySelector("a.mobileBrand span").innerText="' . $userP->firstname . ' ' . $userP->lastname . '";
            ...
            // }else{
            //     $header .= $CFG->wwwroot.'/theme/edumy/images/teachers/'.$userP->url;
        ...
        $record = $DB->get_record('teacher_styles', array('teacher_id' => $user_data));
        $header .= "<style>
          ...
          button
          {
            background-color:" . $record->button_color . " !important;
            color:" . $record->color . " !important  ;
            border:2px solid " . $record->color . " !important;
            transition :all 3.s ease-in-out;

          }
          a#prev-activity-link, a#next-activity-link, a.ccn-mod-forum-btn , a.feedbackBtn, a.reserveBtn{
            background-color:" . $record->button_color . " !important;
            color:" . $record->color . " !important  ;
            border:2px solid " . $record->color . " !important;
            transition :all 3.s ease-in-out;
          ...
          .region-main-settings-menu , #region-main-settings-menu ,
          .context-header-settings-menu{background-color:" . $record->button_color . " !important;}
          .breadcrumb_widgets{background-color:" . $record->button_color . " !important;}
          .breadcrumb-item , .breadcrumb-item a ,
          div.editor_atto_toolbar button .icon{color:".$record->color." !important ; }
          .panel-title{background-color:" . $record->button_color . " !important;}
          .title{color:".$record->color." !important ;}
          .breadcrumb-item::before{color:".$record->color." !important ;}
          .accordion-toggle{color:".$record->color." !important ; }
          .dbxshad{background-color:" . $record->button_color . " !important;}
          input[type='submit'] , .qnbutton , input[type='button']{
            border-color:".$record->button_color."!important;
          }
          input[type='submit']:hover , 
          input[type='button']:hover,.fp-toolbar div a:hover ,
          .fp-viewbar a:hover , .fa-th::before {color:".$record->color." !important ; }
          .qnbutton,.flaticon-magnifying-glass:before{color:". $record->button_color ." !important ;}
          #accordion .panel-heading .accordion-toggle.collapsed::before{
            color:".$record->color." !important ; 
          }
          .fp-toolbar div a , .fp-viewbar a ,.fp-viewbar a:hover ,::-webkit-file-upload-button ,
          ...
          .#accordion .panel-heading .collapsed::before{color:".$record->color." !important ;}
          ::-webkit-file-upload-button{color:".$record->color." !important ;}
          input[type='file']{
            color:".$record->color." !important ;
            background-color:" . $record->button_color . " !important;
          }

          .fp-repo .nav-link{background-color:" . $record->button_color . " !important;}
          a.ccn-mod-forum-btn:hover,a.ccn-mod-forum-btn:focus{
            color:" . $record->button_color . " !important;
            border-color:".$record->button_color."!important;
          }
          .fa-star-o{color:".$record->color." !important ;}
          .submissionlinks a{
            background-color:".$record->button_color."!important;
            border-color:".$record->button_color."!important;
          }
          .submissionlinks a:hover{
        ...
        .no-overflow::-webkit-scrollbar-thumb {
            border-radius:5px;
            background: ".$record->button_color."!important; 
        }

        .fp-repo a span{color:".$record->color."!important;}
        .fp-repo{margin-bottom:5px;}
        .fp-repo a:hover{
            border:2px solid ".$record->button_color.";
            background-color:".$record->color." !important;
        }
        .fp-repo a:hover span{
            color:".$record->button_color." !important;
        }
          
          button:hover{
              background-color:" . $record->hover . " !important;
              border:2px solid " . $record->hover . " !important;
              color:" . $record->color . " !important  ;

          }
          a#prev-activity-link :hover , a#next-activity-link :hover, a.feedbackBtn:hover, a.reserveBtn:hover{
            background-color:" . $record->hover . " !important;
            color:" . $record->color . " !important  ;
            border:2px solid " . $record->hover . " !important;
          }
          body{
              background-color :" . $record->bgcolor . " !important;
          }
          ...
          .footer_one{
              background-color:" . $record->footer . "!important;
          ...
          .ccn-parallax-bg-849:before {
            background-color:" . $record->bgblock . "!important;
          }
          .scrollToHome{
            background-color:" . $record->links . "!important;
          }
          button.btn-link{
          ...
          $teacherId = $DB->get_record("user", array("id" => $teacherId->id));
          $header .= '<script>
          $( document ).ready(function() {
    $("#footerImage").attr("src","'.$this->upload_user_image($teacherId->id).'");
    $("#teachername").text("'.$teacherId->firstname.' '.$teacherId->lastname.'");
        ...
        if(!empty($_SESSION['userdata'])){
            $header .= '<script>
            $( document ).ready(function() {
                $(".navbar_brand").attr("href","'.$CFG->wwwroot.'/?id='.$_SESSION['userdata'].'");
            });
            </script>'; 
        }
