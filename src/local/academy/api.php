...
$publicfunctions = ['get_frontpage_blocks', 'get_theme_tokens', 'get_theme_logo_settings', 'get_theme_footer_settings'];
if (in_array($function, $publicfunctions, true)) {
    try {
        switch ($function) {
            ...
            // Footer settings from edumy theme (public: footer content is shown to everyone).
            case 'get_theme_footer_settings':
                academy_respond(['status' => 'success', 'data' => ['footer' => local_academy_get_theme_footer_settings()]]);
                break;
        }
    } catch (Exception $e) {
