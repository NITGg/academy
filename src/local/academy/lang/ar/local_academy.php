...
$string['fr_sub_b2b_help']      = 'اشتراك أعمال: جهة تشتري عددًا من المقاعد بخصم كمّي ثم تدعو أعضاءها لشغلها. عملية بيع واحدة تغطي عدة مستخدمين، لذا يُقاس بالإيراد لكل مقعد لا لكل عملية.';
// تبويب المقررات.
...
$string['cert_desc']                    = 'عرّف قواعد الأهلية التي تقرر استحقاق الطالب لكل شهادة في الكورس. يمكن أن يحتوي الكورس على عدة شهادات (مثل: الإتمام، الحضور، التميّز). هذه مجرد طبقة أهلية ولا تُنشئ شهادات: أما العرض وملف PDF والتحقق والتنزيل فتبقى ضمن إضافة الشهادات. وعند توفّر نشاط Custom Certificate، اربطه بالأسفل ليبقى هو المصدر الوحيد للحقيقة.';
$string['cert_course']                  = 'رقم الكورس';
$string['cert_load']                    = 'تحميل';
$string['cert_new']                     = '+ شهادة جديدة';
$string['cert_none']                    = 'لا توجد شهادات لهذا الكورس بعد.';
