...
$string['mc_desc']            = 'المستخدمون الذين اشتروا كورساً منفرداً. استخدم «إلغاء الشراء» لإلغاء تسجيل المستخدم وإلغاء عملية الشراء. [v2]';
...
$string['cert_desc']                    = 'عرّف أهلية شهادات البرامج. اختر برنامجاً لعرض شهاداته، ثم أنشئ أو عدّل أو احذف. كل شهادة لها قاعدة أهلية واحدة تحدد استحقاق الطالب لها. شهادات الكورسات تُدار من مكان آخر (نشاط Custom Certificate داخل الكورس). هذه معلومات أهلية فقط — لا تُصدر ولا تُحمّل أي شهادة من هنا.';
$string['cert_programs_heading']        = 'البرامج';
$string['cert_manage']                  = 'إدارة الشهادات';
$string['cert_back']                    = 'الرجوع إلى البرامج';
$string['cert_prog_certs']              = 'الشهادات — {$a}';
...
$string['cert_note']                    = 'يجب أن يحقق الطالب القاعدة أعلاه قبل اعتبار هذه الشهادة متاحة. الشهادة المعطّلة تعني عدم أهلية أي طالب.';
...
// بطاقة الطالب في صفحة البرنامج.
$string['cert_student_title']           = 'شهادات البرنامج';
$string['cert_student_eligible']        = 'مؤهل';
$string['cert_student_not_eligible']    = 'قيد التقدّم';
$string['cert_student_all']             = 'يجب أن تحقق جميع الشروط التالية.';
$string['cert_student_any']             = 'يجب أن تحقق شرطاً واحداً على الأقل مما يلي.';
