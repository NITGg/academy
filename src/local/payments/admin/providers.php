...
if (empty($providers)) {
    ...
    foreach ($providers as $p) {
        ...
        $actions = html_writer::link($toggle_url, $p->enabled ? 'Disable' : 'Enable', ['class' => 'btn btn-sm btn-outline-secondary mr-1']);
        $actions .= html_writer::link($up_url, '↑', ['class' => 'btn btn-sm btn-outline-secondary mr-1']);
        ...
        $actions .= ' ' . html_writer::link($settings_url, 'Settings', ['class' => 'btn btn-sm btn-outline-primary ml-1']);
