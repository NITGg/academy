...
$string['frontend_url'] = 'Frontend site URL';
$string['frontend_url_desc'] = 'Base URL of the front-end site (e.g. https://app.example.com). When set, after a payment the student is sent back to the matching page on this site (course / subscriptions / package / program) instead of the Moodle pages. Leave empty to keep the default Moodle result pages.';
...
$string['invoice_item_program'] = 'Program';
