...
echo '<iframe src="'.$response['body']['player_embed_url'].'" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" width="640" style="height:100% !important" allowfullscreen></iframe>';
echo $OUTPUT->footer();
