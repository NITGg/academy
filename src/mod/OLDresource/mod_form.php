...
//        $mform->addElement('file', 'files', get_string('showsize', 'resource'));
        ...
        // $mform->addElement('file', 'url', "Choose a vedio file",array('MAX_FILE_SIZE'=>"6291456"));
        // // $mform->addRule('url', null, 'required', null);
        // $mform->addElement('text', 'vname', "write the vedio name");
        // $mform->addElement('text', 'vdescription', "write the vedio description");
        //-------------------------------------------------------
