...
$governorates = $DB->get_records('governorates');
...
echo '
    ...
    <div class="centered ">اهلا بكم في اكاديمية التفوق</div>
    </div>

    <div class="container allData">
        ...
        <div class="form-group col-lg-4">
            ...
            <input type="text" class="form-control inputCheck" id="username" name="username"  placeholder="' . get_string('usernamePH', 'theme_edumy') . '"  required>
        </div>

        <div class="form-group col-lg-4">
            <label for="exampleInputEmail1">' . get_string('firstnameS', 'theme_edumy') . '</label>
            <input type="text" class="form-control inputCheck" id="firstname" name="firstname"  placeholder="' . get_string('firstnamePH', 'theme_edumy') . '" required>
        </div>
        <div class="form-group col-lg-4">
            <label for="exampleInputEmail1">' . get_string('LastnameS', 'theme_edumy') . '</label>
            <input type="text" class="form-control inputCheck" id="lastname" name="lastname"  placeholder="' . get_string('LastnamePH', 'theme_edumy') . '" required>
        </div>
        ...
        <div class="form-group col-lg-6">
            ...
            <input type="email" class="form-control inputCheck" id="email" name="email" aria-describedby="emailHelp" placeholder="' . get_string('emailPH', 'theme_edumy') . '" required>
        </div>
        <div class="form-group col-lg-6">
        <label for="Sphone" >' . get_string('Sphone', 'theme_edumy') . '</label>
        <input type="text" class="form-control inputCheck" id="Sphone" name="Sphone"  placeholder="' . get_string('Sphone', 'theme_edumy') . '" >
        ...
        <div class="form-group" >
            ...
            <input type="email" class="form-control inputCheck" id="studentEmail" name="studentEmail" aria-describedby="emailHelp" placeholder="' . get_string('studentEmailPH', 'theme_edumy') . '">
        </div>
        <div class="form-group" >
            <label for="parentPhone">' . get_string('Pphone', 'theme_edumy') . '</label>
            <input type="text" class="form-control inputCheck" id="parentPhone" name="parentPhone" aria-describedby="emailHelp" placeholder="' . get_string('Pphone', 'theme_edumy') . '">
        </div>
    </div>
        <div id="studentYear">
     ...
     <select class="form-select form-control inputCheck" name="teacher" aria-label="Default select example">
...
echo ' </select>
 ...
 <input type="text" class="form-control inputCheck" id="center" name="center"  placeholder="' . get_string('center', 'theme_edumy') . '" >
...
<input type="text" class="form-control inputCheck" id="school" name="school"  placeholder="' . get_string('school', 'theme_edumy') . '" >
    </div>
    <div class="form-group col-lg-6">
    <label for="Sphone" >' . get_string('age', 'theme_edumy') . '</label>
    <input type="date" class="form-control inputCheck" id="age" name="age"  placeholder="' . get_string('school', 'theme_edumy') . '" >
        </div>
</div>
...
<select class="form-select form-control inputCheck" name="year" id="year" aria-label="Default select example">
...
<div class="form-group col-lg-4">
<label for="exampleInputPassword1">' . get_string('dept', 'theme_edumy') . '</label>
<select class="form-select form-control inputCheck" name="dept" id="dept">
<option selected>اختار الشعبه </option>
    
<option value="1">علمي علوم </option>
<option value="2">علمي رياضه </option>  
<option value="3">ادبي</option>
</select>
            </div>
            <div class="form-group col-lg-4">
            <label for="exampleInputPassword1">' . get_string('gov', 'theme_edumy') . '</label>
            <select class="form-select form-control inputCheck" name="gov" id="gov">
            <option selected>اختار المحافظة </option>';

foreach ($governorates as $govs) {
echo '<option value="' . $govs->id . '">' . $govs->governorate_name_ar . '</option>';
}
echo '</select>
            </div>
</div>
...
<div class="form-group col-lg-6">
<label for="parentphone" >' . get_string('Pphone', 'theme_edumy') . '</label>
<input type="text" class="form-control inputCheck" id="parentphone1" name="Pphone1"  placeholder="رقم هاتف الاب" >

</div>
<div class="form-group col-lg-6">
<label for="parentphone" >' . get_string('Pphone', 'theme_edumy') . '</label>
<input type="text" class="form-control inputCheck" id="parentphone1" name="Pphone1"  placeholder="رقم هاتف الام" >
...
<input type="password" class="form-control inputCheck" id="password" name="password" placeholder="' . get_string('PasswordPH', 'theme_edumy') . '" required>
</div>
<div class="form-group col-lg-6">
<label for="exampleInputPassword1">' . get_string('confirmPass', 'theme_edumy') . '</label>
<input type="password" class="form-control inputCheck" id="confirmPass" name="confirmPass" placeholder="' . get_string('confirmPass', 'theme_edumy') . '" required>
</div>
</div>
        </div>
