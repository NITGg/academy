...
//teacher block
$string['click'] = 'أضغط للتعديل';
$string['team'] = 'فريق العمل';
$string['follow'] = 'تابعني';
$string['phone'] = "الهاتف/الواتس اب";
$string['teacher_courses'] = "مقررات المعلم";
$string['your_courses'] = "مقرراتك";
$string['enter'] = 'أدخل';
$string['about'] = 'عن نظامنا';
$string['courseAddCode'] = 'أضف الكود';
$string['list_root_and'] = 'غير متاح الا اذا  : ';
$string['bulk'] = 'اضافة مجموعه من الطلاب /  اولياء الامور';
$string['add'] = 'أضف';
$string['save'] = 'حفظ';
$string['back'] = 'الرجوع';
$string['next'] = 'التالى';
$string['all'] = 'الكل';
$string['pdf'] = 'تفعيل ال PDF';
$string['url'] = 'تفعيل ال URL';

$string['enable_bbb'] = "تفعيل ال big Blue button";
$string['enable_quiz'] = "تفعيل الاختبار";
$string['enable_assign'] = "تفعيل الواجب";
$string['enable_page'] = "تفعيل الدرس";
$string['enable_file'] = "تفعيل الدرس كفيديو";
$string['enable_forum'] = "تفعيل المناقشات";
$string['permission'] = "ليس لديك صلاحيات للاضافه . أذا كنت تريد من فضلك تواصل مع المسؤول";
$string['bbb_reports'] = "تقارير ال BBB";
$string['select_teacher'] = 'أختار مدرس';
$string['select_teacher2'] = 'اختار مدرس لرؤية مقراراته';
//sign up 
$string['FirstName'] = 'الاسم الأول';
$string['SecondName'] = 'الاسم الثاني';
$string['LastName'] = 'الاسم الأخير';
$string['Third_Name'] = 'الاسم الثالث';
$string['Email'] = 'البريد الإلكتروني';
$string['Phone'] = 'رقم هاتفك';
$string['Phone2'] = 'رقم هاتف ولي الامر';

$string['Password'] = 'كلمة المرور';
$string['ConfirmPassword'] = 'تأكيد كلمة المرور';
$string['address'] = 'العنوان بالتفصيل';
$string['center_name'] = 'اسم السنتر';
$string['year'] = 'السنه';
$string['sec1'] = 'الصف الاول الثانوي';
$string['sec2'] = 'الصف الثاني الثانوي';
$string['sec3'] = 'الصف الثالث الثانوي';
$string['create_new_acc'] = 'انشاء حساب جديد';
$string['have_account'] = 'لديك حساب بالفعل؟';
$string['no_account'] = 'ليس لديك حساب؟';
$string['agree'] = 'لقد قرات ووافقت على ال';
$string['terms'] = 'تعليمات الاستخدام';
$string['enterFname'] = 'الرجاء ادخال الاسم الاول';
$string['enterLname'] = 'الرجاء إدخال اسمك الأخير';
$string['enterPass'] = 'الرجاء إدخال كلمة مرور';
$string['pass6'] = 'يجب أن تتكون كلمة المرور الخاصة بك من 6 أحرف على الأقل';
$string['enterEmail'] = 'يرجى إدخال عنوان بريد إلكتروني صالح';
$string['enterSnumber'] = 'يرجى إدخال رقمك';
$string['snumber11'] = 'يجب أن يتكون رقمك من 11 حرفًا على الأقل';
$string['enterPnumber'] = 'يرجى تقديم رقم ولي الامر';
$string['pnumber11'] = 'يجب أن يتكون رقم ولي الامر من 11 حرفًا على الأقل';
$string['enterSchool'] = 'الرجاء إدخال مدرسة صالحة';
$string['enterGov'] = 'الرجاء إدخال محافظة صالحة';
$string['required'] = '(مطلوب)';
$string['government'] = 'المحافظه';
$string['school'] = 'المدرسه';
$string['equalTo'] = 'كلمة السر غير متطابقة';
$string['mail_exists'] = 'الايميل موجود بالفعل';
$string['not_matching'] = 'غير متطابقان';
$string['matching'] = 'متطابقان';
$string['check_pass'] = 'تأكد من كلمة السر';
$string['newpass'] = 'تم التعديل برداء تسجيل الدخول';
$string['images'] = 'الصور';
$string['videos_pr'] = 'الفديوهات';
$string['centers_pr'] = 'السناتر التعليمية';
$string['courses_pr'] = 'الكورسات';
$string['phone2_pr'] = 'رقم الهاتف 2';
$string['department_pr'] = 'القسم';
$string['institution_pr'] = 'المؤسسة';
$string['country_pr'] = 'الدولة';
$string['parentname_pr'] = 'اسم ولي الامر';
$string['about_pr'] = 'نبذة عن';

/* $string['firstname_pr'] = 'الأسم الأول';
$string['lastname_pr'] = 'الأسم الثاني';
$string['email_pr'] = 'البريد الألكتروني';
$string['phone_pr'] =  'رقم الهاتف'; */
/* $string['address_pr'] = 'العنوان';
$string['year_pr'] = 'المرحلة التعليمية';
$string['school_pr'] = 'المدرسة';
$string['center_pr'] = 'الستنتر التعليمي';
$string['parentphone_pr'] = 'هاتف ولي الامر'; */
