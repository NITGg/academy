...
//teacher block
$string['click'] = 'Click here to edit';
$string['team'] = 'Team';
$string['follow'] = 'Follow Me';
$string['phone'] = "Mobile/whatsapp";
$string['teacher_courses'] = "Our Regular Courses";
$string['your_courses'] = "Your Courses";
$string['enter'] = 'Enter';
$string['about'] = 'About Our System ?';

$string['courseAddCode'] = 'Add Code';
$string['list_root_and'] = 'Not available unless:';
$string['bulk'] = 'Add bulk of students/parents';
$string['add'] = 'Add';
$string['save'] = 'Save';
$string['back'] = 'Back';
$string['next'] = 'Next';
$string['select_teacher'] = 'Select A teacher';
$string['select_teacher2'] = 'Select A teacher To  Show his courses';
$string['all'] = 'All';
$string['pdf'] = 'Enable PDF';
$string['url'] = 'Enable URL';

$string['enable_bbb'] = "Enable Big Blue Button ";
$string['enable_quiz'] = "Enable Quiz Activity ";
$string['enable_assign'] = "Enable Assignment Activity ";
$string['enable_page'] = "Enable Lesson Activity ";
$string['enable_file'] = "Enable Video Lesson Activity ";
$string['enable_forum'] = "Enable Forum Activity ";
$string['permission'] = "  You Don't have permission to Add . if you want contact the adminstrator";
//sign up
...
$string['Phone2'] = 'Your Parent Phone';
$string['Password'] = 'Password';
$string['ConfirmPassword'] = 'Confirm Password';
$string['center_name'] = 'center name';
$string['year'] = 'Year';
$string['sec1'] = 'First grade secondary';
$string['sec2'] = 'Second grade secondary';
$string['sec3'] = 'Third grade secondary';
$string['agree'] = 'I have read and agree to the';
$string['terms'] = 'Terms of use';
$string['enterFname'] = 'Please enter your firstname';
$string['enterLname'] = 'Please enter your lastname';
$string['enterPass'] = 'Please provide a password';
$string['pass6'] = 'Your password must be at least 6 characters long';
$string['enterEmail'] = 'Please enter a valid email address';
$string['enterSnumber'] = 'Please provide your number';

$string['snumber11'] = 'Your number must be at least 11 characters long';
$string['enterPnumber'] = 'Please provide your parent number';
$string['pnumber11'] = 'Your parent number must be at least 11 characters long';
$string['enterSchool'] = 'Please enter a valid school';
$string['enterGov'] = 'Please enter a valid governorate';
$string['required'] = '(required)';
$string['create_new_acc'] = 'Create a new Account';
$string['have_account'] = 'Already have an account?';
$string['no_account'] = "Don't have an account?";
$string['government'] = 'Government';
$string['school'] = 'school';
$string['equalTo'] = 'passwords are not the same';
$string['mail_exists'] = 'Mail exists';
$string['not_matching'] = 'Not Matching';
$string['matching'] = 'Matching';
$string['check_pass'] = 'Check password';
$string['newpass'] = 'Updated Login with new password';
$string['images'] = 'Images';
$string['videos_pr'] = 'Videos';
$string['centers_pr'] = 'Centers';
$string['courses_pr'] = 'Courses';
$string['phone2_pr'] = 'Phone2';
$string['department_pr'] = 'Department';
$string['institution_pr'] = 'Institution';
$string['country_pr'] = 'Country';
$string['parentname_pr'] = 'Parent Name';
$string['about_pr'] = 'About';

//$string['firstname_pr'] = 'FirstName';
//$string['lastname_pr'] = 'LastName';
//$string['email_pr'] = 'Email';
//$string['phone_pr'] = 'Phone';
//$string['address_pr'] = 'Address';
//$string['year_pr'] = 'Year';
//$string['school_pr'] = 'School';
//$string['center_pr'] = 'Center';
//$string['parentphone_pr'] = 'Parent Phone';
